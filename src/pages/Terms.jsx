  ...
  return (
    <div className="about-page container section animate-fade-in" style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div className="terms-content" style={{ color: 'var(--color-text-secondary)', lineHeight: '1.8' }}>
        ...
        <p>
          Welcome to MZ STUDIO (ABN: 69 353 250 952). By engaging with our web design and development services, you agree to be bound by the following Terms and Conditions. Please read them carefully before initiating any projects.
        </p>
